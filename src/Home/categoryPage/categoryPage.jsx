...
import saintPetersburg from './imgs/main/section__places/saint-petersburg.svg';
...
import Castle from './imgs/main/asd.png'
import xc from './imgs/main/xc.png'
const CategoryPage = () => {
        ...
        {loading ? (
            ...
            <div className={cl.wrapper}>
                      ...
                      <Link to={'/accountPage'}>
                        <div className={cl.header__block__1}>
                          <div className={cl.header__block__1__image__block}>
                            <img className={cl.img} src={`${base?.user?.photoBase64Url}`} alt="Нет данных" />
                          </div>
                          <div className={cl.header__text}>
                            <div className={cl.header__block__1__name}>{base.user?.name ? base.user?.name : <span>Нет данных</span>}</div>
                            <div className={cl.header__block__1__saves}>{base.user?.liked?.length} <span>сохранений</span> </div>
                          </div>
                        </div>
                      </Link>
              ...
              <main className={cl.main}>
                ...
                <Slider  className={cl.section__slider}/>
                <Posts />
              </main>
