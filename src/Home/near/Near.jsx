        ...
        <div>
            ...
            <div className={cl.main}>
                ...
                <div className={cl.nearPlace}>
                    Чтобы приложение подсказало ближайшие места рядом с вами, поделитесь геолокацией с ботом в чате. <span className={cl.link}>Смотри как это сделать тут</span>
                </div>

            <div className={cl.cards}>
                {data?.posts?.map((post, index) => (
                    <div className={cl.card} key={post.id}><button onClick={() => handleButtonClick(post.id, post.id)} className={cl.mainLike}>
